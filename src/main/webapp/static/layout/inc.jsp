...
<script src="<%=request.getContextPath() %>/static/js/bootstrapvalidator/dist/js/bootstrapValidator.min.js"></script>
<script src="<%=request.getContextPath() %>/static/js/angular/angular.min.js"></script>
