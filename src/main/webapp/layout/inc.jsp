...
<link href="<%=request.getContextPath() %>/js/bootstrapvalidator/dist/css/bootstrapValidator.min.css" rel="stylesheet">
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/animate.css" type="text/css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/font-awesome.min.css" type="text/css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/simple-line-icons.css" type="text/css" />
...
<script src="<%=request.getContextPath() %>/js/bootstrapvalidator/dist/js/bootstrapValidator.min.js"></script>
