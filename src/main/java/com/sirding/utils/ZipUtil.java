...
public class ZipUtil {
    ...
    /**
     * 将sourceFilePath 压缩为zipFilePath
     * 
    ...
    public static boolean zipFile(String sourceFilePath,String zipFilePath){
        ...
        if(!source.isFile()){
            logger.info(sourceFilePath+" is not a file.");
            return result;
        }
        File zipFile=new File(zipFilePath);
        FileOutputStream dest=null;
...
//        String dstPath = "G:/beta/ziptest.zip";
//		String srcPath = "G:/beta/ziptest";
//		ZipUtil.zip(srcPath, dstPath);
    	
    	String dstPath = "G:/beta/ziptest/c.zip";
    	String srcPath = "G:/beta/ziptest/c.txt";
    	ZipUtil.zipFile(srcPath, dstPath);
    }
}
